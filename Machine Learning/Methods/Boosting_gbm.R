...
# modify hyperparameter grid around optimal hyper-parameters
hyper_grid <- expand.grid(
...
#models <- data.frame(models=1:10)
#grid_search <- cbind(models, grid_search)
...
sumTable_boost1 <- data.frame(model="Full Model Boosting", p=111, cv_error=78.95, leaderboard=67.04)
sumTable_boost2
